...
#endif
{
    namespace Model.Scene
    {
        ...
        public abstract partial class SceneNode : DisposeObject, IComparable<SceneNode>, Animations.IAnimationNode
        {
            ...
            /// </summary>
            /// <param name="args">The arguments.</param>
            protected void RaiseOnTransformBoundSphereChanged(BoundChangeArgs<global::Vortice.Mathematics.BoundingSphere> args)
            {
            ...
            /// </summary>
            /// <param name="args">The arguments.</param>
            protected void RaiseOnBoundSphereChanged(BoundChangeArgs<global::Vortice.Mathematics.BoundingSphere> args)
            {
