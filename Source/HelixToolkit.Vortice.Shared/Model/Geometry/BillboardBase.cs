    ...
    public abstract class BillboardBase : Geometry3D, IBillboardText
    {
            ...
            object originalSource, int count)
        {
            ...
            for (var i = 0; i < count; ++i)
            {
                ...
                var c = Vector3.Transform(pos, modelMatrix);
            ...
            object originalSource, int count)
        {
            ...
            for (var i = 0; i < count; ++i)
            {
                ...
                if (rayWS.Intersects(quad.TL, quad.TR, quad.BR, out Vector3 hitPoint)
                    || rayWS.Intersects(quad.TL, quad.BR, quad.BL, out hitPoint))
                {
            ...
            ref Matrix viewMatrix, ref Matrix viewMatrixInv)
        {
            ...
            bl = Vector3.Transform(bl, viewMatrixInv);
            br = Vector3.Transform(br, viewMatrixInv);
            tr = Vector3.Transform(tr, viewMatrixInv);
            tl = Vector3.Transform(tl, viewMatrixInv);
        ...
        {
            var vcenter = Vector3.Transform(center, screenViewProjection);
