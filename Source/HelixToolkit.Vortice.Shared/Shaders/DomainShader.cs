...
#endif
{
    namespace Shaders
    {
        ...
        {
            private global::Vortice.Direct3D11.ID3D11DomainShader shader;
            internal global::Vortice.Direct3D11.ID3D11DomainShader Shader => shader;
            ...
            {
                shader = device.CreateDomainShader(byteCode);
