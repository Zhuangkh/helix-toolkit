...
#endif
{
    namespace Shaders
    {
        ...
        {
            private global::Vortice.Direct3D11.ID3D11GeometryShader shader;
            internal global::Vortice.Direct3D11.ID3D11GeometryShader Shader => shader;
            ...
            public GeometryShader(Device device, string name, byte[] byteCode, StreamOutputElement[] streamOutputElements, int[] bufferStrides,
                int rasterizedStream = global::Vortice.Direct3D11.StreamOutputNoRasterizedStream)
