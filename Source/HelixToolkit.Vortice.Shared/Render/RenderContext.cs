...
#endif
{
    ...
    public sealed class RenderContext : DisposeObject, IRenderMatrices
    {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ShaderResourceViewProxy GetOffScreenTexture(OffScreenTextureType type, OffScreenTextureSize size, global::Vortice.DXGI.Format format)
        {
            switch (type)
            {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ShaderResourceViewProxy GetOffScreenRT(OffScreenTextureSize size, global::Vortice.DXGI.Format format)
        {
            switch (size)
            {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ShaderResourceViewProxy GetOffScreenRT(OffScreenTextureSize size, global::Vortice.DXGI.Format format, out int width, out int height)
        {
            switch (size)
            {
                case OffScreenTextureSize.Full:
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ShaderResourceViewProxy GetOffScreenDS(OffScreenTextureSize size, global::Vortice.DXGI.Format format)
        {
            switch (size)
            {
                case OffScreenTextureSize.Full:
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ShaderResourceViewProxy GetOffScreenDS(OffScreenTextureSize size, global::Vortice.DXGI.Format format, out int width, out int height)
        {
            switch (size)
            {
                case OffScreenTextureSize.Full:
