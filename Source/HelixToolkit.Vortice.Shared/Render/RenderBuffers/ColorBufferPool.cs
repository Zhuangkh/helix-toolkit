    ...
    namespace Render
    {
        ...
        public sealed class PingPongColorBuffers : DisposeObject
        {
            ...
            private Texture2DDescription texture2DDesc = new Texture2DDescription()
            {
                ...
                SampleDescription = new global::Vortice.DXGI.SampleDescription(1, 0)
            };
            ...
            public PingPongColorBuffers(global::Vortice.DXGI.Format textureFormat, int width, int height, IDevice3DResources deviceRes)
            {
