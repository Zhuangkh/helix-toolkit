...
using Texture1D = Vortice.Direct3D11.ID3D11Texture1D;
using Resource = Vortice.Direct3D11.ID3D11Resource;
using ResourceRegion = Vortice.Mathematics.Box;
#if DX11_1
using Device = Vortice.Direct3D11.ID3D11Device1;
using DeviceContext = Vortice.Direct3D11.ID3D11DeviceContext1;
using Texture2D = Vortice.Direct3D11.ID3D11Texture2D1;
using Texture3D = Vortice.Direct3D11.ID3D11Texture3D1;
#else
using Device = Vortice.Direct3D11.ID3D11Device;
using Texture2D = Vortice.Direct3D11.ID3D11Texture2D;
using Texture3D = Vortice.Direct3D11.ID3D11Texture3D;
...
#endif
{
    namespace Render
    {
        public partial class DeviceContextProxy
        {
            ...
            public MappedSubresource MapSubresource(Texture2D resource, int mipSlice, int arraySlice, MapMode mode, MapFlags flags, out DataStream stream)
            {
                var mappedSubresource = deviceContext.Map(resource, mipSlice, arraySlice, mode, flags, out int subresource, out int mipSize);
                 stream =new DataStream(mappedSubresource.DataPointer,resource.Description.Format.SizeOfInBytes())
                return deviceContext.Map(resource, mipSlice, arraySlice, mode, flags, out stream);
            }
            ...
            /// <returns>The locked SharpDX.DataBox   </returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public MappedSubresource MapSubresource(Texture1D resource, int mipSlice, int arraySlice, MapMode mode, MapFlags flags, out DataStream stream)
            {
                return deviceContext.Map(resource, mipSlice, arraySlice, mode, flags, out stream);
            }
            ...
            /// <returns>The locked SharpDX.DataBox</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public MappedSubresource MapSubresource(Texture3D resource, int mipSlice, int arraySlice, MapMode mode, MapFlags flags, out DataStream stream)
            {
                return deviceContext.Map(resource, mipSlice, arraySlice, mode, flags, out stream);
            }
            ...
            /// <returns>The locked SharpDX.DataBox      </returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public MappedSubresource MapSubresource(Buffer resource, MapMode mode, MapFlags flags)
            {
                return deviceContext.Map(resource, 0, mode, flags);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public MappedSubresource MapSubresource(Buffer resource, MapMode mode, MapFlags flags, out DataStream stream)
            {
                var mappedSubresource = deviceContext.Map(resource, mode, flags);
                stream = new DataStream(mappedSubresource.DataPointer, resource.Description.ByteWidth, canRead: true, canWrite: true);
            ...
            /// <returns></returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public MappedSubresource MapSubresource(Resource resource, int mipSlice, int arraySlice, MapMode mode, MapFlags flags, out int mipSizeOut)
            {
                return deviceContext.Map(resource, mipSlice, arraySlice, mode, flags, out int subresource, out mipSizeOut);
            }
            ...
            /// <returns></returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public MappedSubresource MapSubresource(Resource resource, int subresource, MapMode mode, MapFlags flags, out DataStream stream)
            {
                switch (resource.Dimension)
                {
                    ...
                    default:
                        throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "MapSubresource is not supported for Resource [{0}]", new object[1]
                        {
                    resource.Dimension
                        }));
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public MappedSubresource MapSubresource(Resource resourceRef, int subresource, MapMode mapType, MapFlags mapFlags)
            {
                return deviceContext.Map(resourceRef, subresource, mapType, mapFlags);
            }
            ...
            {
                deviceContext.Unmap(resourceRef, subresource);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void ResolveSubresource(Resource source, int sourceSubresource, Resource destination, int destinationSubresource, global::Vortice.DXGI.Format format)
            {
            ...
            {
                deviceContext.UpdateSubresource(source, resource, subresource, region: region);
            }
            ...
            {
                deviceContext.UpdateSubresourceSafe(ref source, resource, srcBytesPerElement, subresource, isCompressedResource: isCompressedResource);
            }
            ...
            {
                deviceContext.UpdateSubresourceSafe(ref source, resource, srcBytesPerElement, subresource, region, isCompressedResource);
            }
            ...
            {
                deviceContext.CopyResource(destination, source);
            }
            ...
            /// </param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void CopyStructureCount(Buffer dstBufferRef, int dstAlignedByteOffset, ID3D11UnorderedAccessView srcViewRef)
            {
            ...
            {
                deviceContext.CopySubresourceRegion(destination, destinationSubResource, dstX, dstY, dstZ, source, sourceSubresource, sourceRegion);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void GenerateMips(ID3D11ShaderResourceView shaderResourceViewRef)
            {
