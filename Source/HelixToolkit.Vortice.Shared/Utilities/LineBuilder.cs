...
#endif
{
    ...
    public class LineBuilder
    {
        ...
        public void AddCircle(Vector3 position, Vector3 normal, float radius, int segments)
        {
            ...
            {
                axis.Normalize();
                transform = Matrix.CreateFromAxisAngle(axis, (float)Math.Acos(Vector3.Dot(Vector3.UnitY, normal))) * transform;
            }
        ...
        {
            var bb = global::Vortice.Mathematics.BoundingBox.CreateFromPoints(points);
            return GenerateBoundingBox(bb);
        }
        ...
        /// <returns></returns>
        public static LineGeometry3D GenerateBoundingBox(global::Vortice.Mathematics.BoundingBox bb)
        {
        ...
        {
            var bd = new LineBuilder();
            bd.AddCircle(new Vector3D(plane.D) + plane.Normal, plane.Normal, radius, segments);
            return bd.ToLineGeometry3D();
        }
