...
#endif
{
    namespace Utilities
    {
        ...
        public class BoundableNodeOctree : DynamicOctreeBase<SceneNode>
        {
                ...
                : base(null, paramter, queueCache)
            {
                ...
                if (Objects != null && Objects.Count > 0)
                {
                    ...
                    foreach (var item in Objects)
                    {
                        ...
                        bound = BoundingBox.CreateMerged(b, bound);
                    }
                    this.Bound = bound;
                }
            }
            ...
            public override bool FindNearestPointBySphereExcludeChild(HitTestContext context, ref global::Vortice.Mathematics.BoundingSphere sphere, ref List<HitTestResult> points, ref bool isIntersect)
            {
