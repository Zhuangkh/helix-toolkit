    ...
    public static class IViewportExtensions
    {
        ...
        public static BoundingBox FindBoundsInternal(this IViewport3DX viewport)
        {
            ...
            }).Where(x =>
            {
                ...
                {
                    return b.HasBound && b.BoundsWithTransform.Max != b.BoundsWithTransform.Min
                    && b.BoundsWithTransform.Max != Vector3.Zero && b.BoundsWithTransform.Max != maxVector;
                }
                else
                {
                    return false;
            ...
            }))
            {
                ...
                {
                    if (r.HasBound && r.BoundsWithTransform.Max != maxVector)
                    {
                        bounds = global::Vortice.Mathematics.BoundingBox.CreateMerged(bounds, r.BoundsWithTransform);
                    }
                }
            }
            return bounds;
            ...
            if (view.RenderHost != null && view.RenderHost.IsRendering)
            {
                ...
                if (view.RenderHost != null && view.RenderHost.IsRendering)
                {
                    ...
                    Utilities.ScreenCapture.SaveWICTextureToBitmapStream(view.RenderHost.EffectsManager,
                        view.RenderHost.RenderBuffer.BackBuffer.Resource as global::Vortice.Direct3D11.ID3D11Texture2D, memoryStream);
                    return memoryStream;
                }
            }
            return null;
