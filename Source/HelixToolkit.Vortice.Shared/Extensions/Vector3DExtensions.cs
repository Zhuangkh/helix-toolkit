...
using Vortice;
using Size2F = Vortice.Mathematics.Size;
using Size2 = Vortice.Mathematics.SizeI;
#if !NETFX_CORE
...
#endif
{
    public static class VectorExtensions
    {
        ...
        {
            return new Color4(vector.R, vector.G, vector.B, alpha);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color4 Normalize(this Color4 vector)
        {
    ...
    public static class VectorComparisonExtensions
    {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RawRectF ToRectangleF(this Vector2 v)
        {
            return new RawRectF(0, 0, v.X, v.Y);
        }
        /// <summary>
        /// To the rectangle.
        /// </summary>
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RawRect ToRectangle(this Vector2 v)
        {
            return new RawRect(0, 0, (int)v.X, (int)v.Y);
        }
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 ToVector2(this RawRectF v)
        {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 ToRectangle(this RawRect v)
        {
            return new Vector2(v.GetWidth(), v.GetHeight());
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float GetWidth(this RawRect v)
        {
            return v.Right - v.Left;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float GetHeight(this RawRect v)
        {
            return v.Bottom - v.Top;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float GetWidth(this RawRectF v)
        {
            return v.Right - v.Left;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float GetHeight(this RawRectF v)
        {
            return v.Bottom - v.Top;
        }
        /// <summary>
