...
namespace HelixToolkit.Vortice.Core
{
    ...
    public static class CameraExtension
    {
        ...
        /// The zoom rectangle.
        /// </param>
        public static void ZoomToRectangle(this CameraCore camera, ViewportCore viewport, RawRectF zoomRectangle)
        {
            if (camera is ProjectionCameraCore pcam)
            {
                            ...
                            (zoomRectangle.Top + zoomRectangle.Bottom) * 0.5f), out var centerRay))
                {
                    ...
                    if (camera is PerspectiveCameraCore perspectiveCamera)
                    {
                        ...
                        var newDistance = distance * zoomRectangle.GetWidth() / viewport.ViewportRectangle.Width;
                    ...
                    {
                        orthographicCamera.Width *= zoomRectangle.GetWidth() / viewport.ViewportRectangle.Width;
            ...
            this CameraCore camera, ViewportCore viewport, float animationTime = 0)
        {
            ...
            var diagonal = bounds.Max - bounds.Min;
