...
using Vector3 = global::Vortice.Vector3;
#if COREWPF
using HelixToolkit.Vortice.Core;
using HelixToolkit.Vortice.Core.Cameras;
using HelixToolkit.Vortice.Core.Model.Scene;
using HelixToolkit.Vortice.Core.Model.Scene2D;
using HelixToolkit.Vortice.Core.Utilities;
using HitTestResult = HelixToolkit.Vortice.Core.HitTestResult;
#else
using HelixToolkit.Wpf.Vortice.Model.Scene;
using HelixToolkit.Wpf.Vortice.Model.Scene2D;
#endif
namespace HelixToolkit.Wpf.Vortice
{
    ...
    public partial class Viewport3DX : Control, IViewport3DX, IDisposable
    {
        ...
        public global::Vortice.Rectangle ViewportRectangle
        {
            get
            {
                return new global::Vortice.Rectangle(0, 0, (int)ActualWidth, (int)ActualHeight);
            }
        }
