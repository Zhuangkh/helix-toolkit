...
namespace HelixToolkit.Wpf.Vortice
{
    ...
    using global::Vortice.Direct3D;
    using global::Vortice.Direct3D11;
    using global::Vortice.DXGI;
    using System;
    using System.Collections.Generic;
    using System.Linq;
    using Buffer = global::Vortice.Direct3D11.Buffer;
    using Device = global::Vortice.Direct3D11.Device;
    ...
    {        
        ...
        private void InitGBuffer(Format format = Format.R32G32B32A32_Float)
        {
            ...
            this.depthStencilBuffer = new Texture2D(device, new Texture2DDescription()
            {
                ...
                //Format = global::Vortice.DXGI.Format.B8G8R8A8_UNorm,
                ArraySize = 1,
                MipLevels = 1,
                Width = targetWidth,
                Height = targetHeight,
