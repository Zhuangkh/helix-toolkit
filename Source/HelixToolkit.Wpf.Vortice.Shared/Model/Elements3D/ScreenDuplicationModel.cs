...
namespace HelixToolkit.Wpf.Vortice
{
    ...
    /// </summary>
    /// <seealso cref="HelixToolkit.Wpf.Vortice.Element3D" />
    public class ScreenDuplicationModel : Element3D
    {
        ...
        public Rect CaptureRectangle
        {
            ...
            set
            {
                SetValue(CaptureRectangleProperty, value);
            }
        }
        /// <summary>
        ...
        public bool StretchToFill
        {
            ...
            set
            {
                SetValue(StretchToFillProperty, value);
            }
        }
        ...
        public bool ShowMouseCursor
        {
            ...
            set
            {
                SetValue(ShowMouseCursorProperty, value);
            }
        }
